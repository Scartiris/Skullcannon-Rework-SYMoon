...
TABLES = [
    ...
    ("missile_weapons_to_projectiles_tables.tsv", "db/missile_weapons_to_projectiles_tables/skc_rework_phase0", "missile_weapons_to_projectiles_tables", "DB"),
    ("projectile_shot_type_displays_tables.tsv", "db/projectile_shot_type_displays_tables/skc_rework_phase0", "projectile_shot_type_displays_tables", "DB"),
    ("unit_special_abilities_tables.tsv", "db/unit_special_abilities_tables/skc_rework_phase0", "unit_special_abilities_tables", "DB"),
    ("special_ability_to_special_ability_phase_junctions_tables.tsv", "db/special_ability_to_special_ability_phase_junctions_tables/skc_rework_phase0", "special_ability_to_special_ability_phase_junctions_tables", "DB"),
    ("special_ability_phases_tables.tsv", "db/special_ability_phases_tables/skc_rework_phase0", "special_ability_phases_tables", "DB"),
    ("special_ability_phase_stat_effects_tables.tsv", "db/special_ability_phase_stat_effects_tables/skc_rework_phase0", "special_ability_phase_stat_effects_tables", "DB"),
    ("unit_special_ability_to_special_ability_toggle_groups_junctions_tables.tsv", "db/unit_special_ability_to_special_ability_toggle_groups_junctions_tables/skc_rework_phase0", "unit_special_ability_to_special_ability_toggle_groups_junctions_tables", "DB"),
    ("special_ability_exclusive_toggle_groups_tables.tsv", "db/special_ability_exclusive_toggle_groups_tables/skc_rework_phase0", "special_ability_exclusive_toggle_groups_tables", "DB"),
