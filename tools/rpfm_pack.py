...
TABLES = [
    ...
    ("unit_abilities_tables.tsv", "db/unit_abilities_tables/skc_rework_phase0", "unit_abilities_tables", "DB"),
    ("unit_description_short_texts_tables.tsv", "db/unit_description_short_texts_tables/skc_rework_phase0", "unit_description_short_texts_tables", "DB"),
    ("unit_description_historical_texts_tables.tsv", "db/unit_description_historical_texts_tables/skc_rework_phase0", "unit_description_historical_texts_tables", "DB"),
    ...
    ("skc_rework_cn.loc.tsv", "text/!!!!!!translated_locs.loc", "!!!!!!translated_locs", "Loc"),
